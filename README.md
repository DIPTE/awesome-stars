...
- [Xilinx/mlir-aie](https://github.com/Xilinx/mlir-aie) - A close-to-metal Python API for programming AMD Ryzen™ AI NPUs (AI Engines), built on an open-source MLIR-based compiler toolchain.
...
- [nxp-mcuxpresso/legacy-mcux-sdk-examples](https://github.com/nxp-mcuxpresso/legacy-mcux-sdk-examples) - MCUXpresso SDK Examples
...
- [microsoft/T-MAC](https://github.com/microsoft/T-MAC) - Low-bit LLM inference on CPU/NPU with lookup table
...
- [AIDajiangtang/Superpoint-LightGlue-Image-Stiching](https://github.com/AIDajiangtang/Superpoint-LightGlue-Image-Stiching) - OpenCV图像拼接Pipeline集成 SuperPoint 、LightGlue 特征点检测和匹配深度学习模型
...
- [MIT-SPARK/KISS-Matcher](https://github.com/MIT-SPARK/KISS-Matcher) - KISS-Matcher: Fast, Robust, and Scalable Registration + ROS2 SLAM examples
...
- [makendi19841/Parking-Slot-Detection-3D-LiDar-Raw-Ping](https://github.com/makendi19841/Parking-Slot-Detection-3D-LiDar-Raw-Ping) - 3D Lidar Raw Ping To Track Static and Dynamic Objects
...
- [shaoshengsong/DeepSORT](https://github.com/shaoshengsong/DeepSORT) - A real-time multi-object tracking application in C++17 with Qt and ONNX Runtime that runs a YOLO detector with four pluggable trackers — ByteTrack, OC-SORT, Deep OC-SORT, and DeepSORT.
...
- [Postroggy/OC_SORT_CPP](https://github.com/Postroggy/OC_SORT_CPP) - [CVPR 2023] OC-SORT implemented in C++ with Eigen Library, Plus a Android Demo Apk
...
- [xieincz/Multithreaded-YOLOv5-ByteTrack](https://github.com/xieincz/Multithreaded-YOLOv5-ByteTrack) - Multi-thread tracking of YOLOv5 and ByteTrack implemented by C++, accelerated by TensorRT. YOLOv5 和 ByteTrack 的多线程追踪 C++ 实现, 使用 TensorRT 进行推理加速
...
- [Natsu-Akatsuki/RangeNet-TensorRT](https://github.com/Natsu-Akatsuki/RangeNet-TensorRT) - Rangenet++ with high-version TensorRT (e.g.8~10), libtorch, CUDA programming.
...
- [minhanghuang/CyberRT](https://github.com/minhanghuang/CyberRT) - Baidu Apollo v10.0.0 CyberRT Framework  CMake Build
...
- [Hale423/CenterPoint](https://github.com/Hale423/CenterPoint) - TensorRT deployment for CenterPoint Lidar Detection Model.
...
- [microsoft/DirectML](https://github.com/microsoft/DirectML) - ⚠️DirectML is in maintenance mode ⚠️ DirectML is a high-performance, hardware-accelerated DirectX 12 library for machine learning. DirectML provides GPU acceleration for common machine learning tasks 
...
- [JIA-Lab-research/3D-Box-Segment-Anything](https://github.com/JIA-Lab-research/3D-Box-Segment-Anything) - We extend Segment Anything to 3D perception by combining it with VoxelNeXt.
...
- [zhangyujie-1998/MS_GraphSIM](https://github.com/zhangyujie-1998/MS_GraphSIM) - [ACMMM 2021] Official Implementation of the work "MS-GraphSIM: Inferring Point Cloud Quality via Multiscale Graph Similarity"
...
- [LiZhengXiao99/Navigation-Learning](https://github.com/LiZhengXiao99/Navigation-Learning) - 我本科写的导航算法学习笔记，现在意义不大了，在AI帮助下学习算法比看我这个文档更好，所以不再更新。
...
- [lxtGH/Awesome-Segmentation-With-Transformer](https://github.com/lxtGH/Awesome-Segmentation-With-Transformer) - [T-PAMI-2024] Transformer-Based Visual Segmentation: A Survey
...
- [wanghao9610/X-SAM](https://github.com/wanghao9610/X-SAM) - [AAAI2026] X-SAM: From Segment Anything to Any Segmentation
...
- [otaheri/MANO](https://github.com/otaheri/MANO) - A PyTorch Implementation of MANO hand model.
- [lixiny/manotorch](https://github.com/lixiny/manotorch) - MANO hand model in PyTorch (anatomy consistent, anchors, etc)
...
- [nubot-nudt/InsMOS](https://github.com/nubot-nudt/InsMOS) - [IROS 23] InsMOS: Instance-Aware Moving Object Segmentation in LiDAR Data
...
- [gwenzhang/Voxel-Mamba](https://github.com/gwenzhang/Voxel-Mamba) - [NeurIPS24 Spotlight] Voxel Mamba: Group-Free State Space Models for Point Cloud based 3D Object Detection
...
- [Song-Jingyu/LiRaFusion](https://github.com/Song-Jingyu/LiRaFusion) - [ICRA 2024] - We propose LiRaFusion to tackle LiDAR-radar fusion for 3D object detection to fill the performance gap of existing LiDAR-radar detectors.
...
- [BraveGroup/PointSAM-for-MixSup](https://github.com/BraveGroup/PointSAM-for-MixSup) - [ICLR 2024] MixSup: Mixed-grained Supervision for Label-efficient LiDAR-based 3D Object Detection
...
- [spacewalk01/depth-anything-tensorrt](https://github.com/spacewalk01/depth-anything-tensorrt) - C++ TensorRT implementation of Depth-Anything V1, V2
...
- [GAP-LAB-CUHK-SZ/SAMPro3D](https://github.com/GAP-LAB-CUHK-SZ/SAMPro3D) - SAMPro3D: Locating SAM Prompts in 3D for Zero-Shot Instance Segmentation (3DV 2025)
...
- [wangxiyang2022/MMF-JDT](https://github.com/wangxiyang2022/MMF-JDT) - This is the offical implementation of the paper "You Only Need Two Detectors to Achieve Multi-Modal 3D Multi-Object Tracking "
...
- [BraveGroup/FullySparseFusion](https://github.com/BraveGroup/FullySparseFusion) - (TPAMI2024) Fully Sparse Fusion for 3D Object Detection
...
- [lanlan96/3DRM](https://github.com/lanlan96/3DRM) - [Computers & Graphics 2021] Pair-wise Relation Module for 3D Object Detection
...
- [antonioo-c/PiMAE](https://github.com/antonioo-c/PiMAE) - [CVPR2023] Official implementation of “PiMAE: Point cloud and Image Interactive Masked Autoencoders for 3D Object Detecion”
...
- [JIA-Lab-research/ECCV22-P3AFormer-Tracking-Objects-as-Pixel-wise-Distributions](https://github.com/JIA-Lab-research/ECCV22-P3AFormer-Tracking-Objects-as-Pixel-wise-Distributions) - The official code for our ECCV22 oral paper: tracking objects as pixel-wise distributions.
...
- [Luoyadan/CRB-active-3Ddet](https://github.com/Luoyadan/CRB-active-3Ddet) - The official PyTorch implementation of "Exploring Active 3D Object Detection from a Generalization Perspective" (ICLR Spotlight 2023 & TPAMI 2025).
...
- [Linaom1214/TensorRT-For-YOLO-Series](https://github.com/Linaom1214/TensorRT-For-YOLO-Series) - tensorrt for yolo series (YOLOv11,YOLOv10,YOLOv9,YOLOv8,YOLOv7,YOLOv6,YOLOX,YOLOv5), nms plugin support
- [hnuzhy/SSDA-YOLO](https://github.com/hnuzhy/SSDA-YOLO) - [CVIU2023] Codes for my paper "SSDA-YOLO: Semi-supervised Domain Adaptive YOLO for Cross-Domain Object Detection"
...
- [JIA-Lab-research/LargeKernel3D](https://github.com/JIA-Lab-research/LargeKernel3D) - LargeKernel3D: Scaling up Kernels in 3D Sparse CNNs (CVPR 2023)
...
- [vivcheng01/DeepVCP-Pointcloud-Registration](https://github.com/vivcheng01/DeepVCP-Pointcloud-Registration) - 
...
- [sovrasov/flops-counter.pytorch](https://github.com/sovrasov/flops-counter.pytorch) - Flops counter for neural networks in pytorch framework
...
- [haiduo/sparse_model](https://github.com/haiduo/sparse_model) - The four major frameworks for 3D point cloud sparse acceleration, which are currently mainstream, are compared. These include MIT-HAN-LAB's torchsparse, NVIDIA's MinkowskiEngine, TuSimple's spconv, an
...
- [Hale423/CenterFusion](https://github.com/Hale423/CenterFusion) - NN-based radar-camera post sensor fusion implemented by TensorRT
...
- [Toytiny/RadarNet-pytorch](https://github.com/Toytiny/RadarNet-pytorch) - [ECCV'20] RadarNet: Exploiting Radar for Robust Perception of Dynamic Objects (PyTorch - unofficial)
...
- [VISION-SJTU/PillarNet-LTS](https://github.com/VISION-SJTU/PillarNet-LTS) - [ECCV 2022] PillarNet: Real-Time and High-Performance Pillar-based 3D Object Detection
...
- [JIA-Lab-research/FocalsConv](https://github.com/JIA-Lab-research/FocalsConv) - Focal Sparse Convolutional Networks for 3D Object Detection (CVPR 2022, Oral)
...
- [raoraoxiong/face-reid](https://github.com/raoraoxiong/face-reid) - 人脸特征重识别
...
- [Chenguoz/PointSCNet](https://github.com/Chenguoz/PointSCNet) - [Symmetry 2022] Code Release of PointSCNet: Point Cloud Structure and Correlation Learning based on Space Filling Curve guided Sampling
...
- [JIA-Lab-research/PointGroup](https://github.com/JIA-Lab-research/PointGroup) - PointGroup: Dual-Set Point Grouping for 3D Instance Segmentation
...
- [JIA-Lab-research/3DSSD](https://github.com/JIA-Lab-research/3DSSD) - 3DSSD: Point-based 3D Single Stage Object Detector (CVPR 2020)
...
- [benkimbuilds/correlation-cnn](https://github.com/benkimbuilds/correlation-cnn) - Convolutional Neural Network to determine the correlation of a set of points in a graph
...
- [heyjunpenn/aigotools](https://github.com/heyjunpenn/aigotools) - AigoTools can help users quickly create and manage website directory, with built-in site auto-crawling features, and also provides internationalization, SEO, image storage, and other functions. It all
